...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/advert/with_report").permitAll()
                .antMatchers(HttpMethod.GET, "advert/with_report/{advertId}/details").permitAll()
                .antMatchers(HttpMethod.GET, "advert/with_report/details/{reportId}").permitAll()
                .antMatchers(HttpMethod.GET, "advert/with_report/{reportId}/details/delete").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/category/update").permitAll()
                .antMatchers(HttpMethod.GET, "/category/all").permitAll()
                .antMatchers(HttpMethod.GET, "/category/get/{categoryId}").permitAll()
                .antMatchers(HttpMethod.GET, "/category/delete/{categoryId}").permitAll()
                .antMatchers(HttpMethod.POST, "/advert/check_in").permitAll()
